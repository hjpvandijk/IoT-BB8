...
#define ACTION_SWITCH_TO_SHELL_MODE 6
#define ACTION_SWITCH_TO_PULLEY_MODE 7
...
#define OBJECTIVE_SWITCH_TO_SHELL_MODE 7
#define OBJECTIVE_SWITCH_TO_PULLEY_MODE 8
#define OBJECTIVE_INIT 9
#define OBJECTIVE_REBOOT 10
